...
public class Refuge {
    ...
    public String toString() {
        return "Refuge{" + "emailRefuge=" + emailRefuge + ", telephoneRefuge=" + telephoneRefuge + ", faxRefuge=" + faxRefuge + ", adresseRefuge=" + adresseRefuge + ", codePostaleRefuge=" + codePostaleRefuge + ", gouvernementRefuge=" + gouvernementRefuge + ", photoRefuge=" + photoRefuge + ", chat=" + chat + ", chien=" + chien + ", rongeur=" + rongeur + ", autre=" + autre + ", immatriculation=" + immatriculation + ", cin=" + cin + ", nomRefuge=" + nomRefuge + '}';
    }
