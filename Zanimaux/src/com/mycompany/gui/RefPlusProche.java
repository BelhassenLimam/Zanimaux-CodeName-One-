...
public static Coord getCoords(String address) {
 ...
 Form hi = new Form(AffichageRefuge.NomRefProche+" sur carte");
  
    public RefPlusProche() {
         Command cmd;
      try {
        ...
        btnMoveCamera.addActionListener(e->{
            cnt.setCameraPosition(new Coord(getCoords(AffichageRefuge.RefugePlusProche).getLatitude(), getCoords(AffichageRefuge.RefugePlusProche).getLongitude()));
        });
        Style s = new Style();
        ...
        cnt.setCameraPosition(new Coord(getCoords(AffichageRefuge.RefugePlusProche).getLatitude(), getCoords(AffichageRefuge.RefugePlusProche).getLongitude()));
        cnt.zoom(new Coord(getCoords(AffichageRefuge.RefugePlusProche).getLatitude(), getCoords(AffichageRefuge.RefugePlusProche).getLongitude()), 15);   
        cnt.addMarker(
                    ...
                    "Optional long description",
                     evt -> {
                             ToastBar.showMessage(AffichageRefuge.NomRefProche, FontImage.MATERIAL_PLACE);
                     }
            );
        Button btnAddMarker = new Button(AffichageRefuge.NomRefProche);
